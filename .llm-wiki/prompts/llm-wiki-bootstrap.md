...
After finishing, write a run manifest to .llm-wiki/runs/run-bootstrap-<timestamp>.json recording what this run did, so CI can confirm the wiki stayed in sync with the code. JSON shape:
{
  "task": "bootstrap",
